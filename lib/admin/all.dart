...
import 'package:flutter_app/admin/addmov.dart';
...
class _allState extends State<all> {
  ...
  Stream<QuerySnapshot> getall(String textsearch) {
    widget.namecategory == 'مسلسلات' ? cat = 'series' : cat = 'movices';
    if (textsearch == '') {
      var move = FirebaseFirestore.instance
          .collection('${cat}')
          .orderBy('timestamp', descending: true);
      var data = move.snapshots();
      return data;
    } else {
